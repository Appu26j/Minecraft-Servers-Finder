...
public class Main
{
                ...
                for (String ngrokIP : allNgrokIPs)
                {
                    new Thread(() ->
                    {
                        try
                        {
                            ...
                            String lineFour = "Version: " + getVersion(mcPingResponse.getVersion().getName());
    ...
    {
        return line.toLowerCase().contains("yes") || line.toLowerCase().contains("yep") || line.toLowerCase().contains("ya") || line.toLowerCase().contains("yah") || line.toLowerCase().contains("yeah") || line.toLowerCase().contains("yeh") || line.toLowerCase().contains("yup") || line.toLowerCase().contains("ye") || line.toLowerCase().contains("yea");
    }

    public static String getVersion(String version)
    {
        String result = (version.startsWith("1") ? version : version.substring(version.indexOf("1"))) + " ";
        result += "(" + (version.startsWith("1") ? "Vanilla" : version.substring(0, version.indexOf("1") - 1)) + ")";
        return result;
    }
